...
document.getElementById("doubleClick").addEventListener("click", () => {
  if(ammo>=30 && !doubleClickCooldown){ammo-=30; clickPower*=2; doubleClickCooldown=true; updateDisplays();
...
setInterval(()=>{
  ...
  if(invasionProgress>100){
    ...
    if(defense >= invasionStrength){ showDamage(`-${invasionStrength} enemies defeated!`);}
    else{
